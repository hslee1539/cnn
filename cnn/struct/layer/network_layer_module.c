...
struct cnn_Layer* cnn_create_network_layer(int size){
    struct cnn_Layer* newLayer = cnn_create_layer(cnn_NETWORK_LAYER_NAME, size, 1, cnn_network_layer_forward, cnn_network_layer_backward, cnn_network_layer_initForward, cnn_network_layer_initBackward, cnn_network_layer_releaseInnerData, cnn_network_layer_update);
